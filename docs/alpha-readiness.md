...
| [5. Composition Foundations](alpha-readiness/05-composition-foundations.md) | Current / Authorized | Presenter ADR/path, external textures, measured layout, overlays, chrome, collections | Very large; `REND-ADR-01` accepted, `REND-03` next, then checkpoint the shared-`Ui` seams |
