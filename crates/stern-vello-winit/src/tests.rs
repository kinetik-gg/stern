...
use stern_core::{Color, PhysicalSize as CorePhysicalSize, ScaleFactor, Size, ViewportInfo};
use stern_render::{RenderDiagnostic, RenderFrameInput, RenderFrameOutput, RenderResources};
