...
mod outliner_conformance {
    ...
    fn item(raw: u64, parent: Option<u64>, label: &str) -> kinetik_ui_widgets::OutlinerItem {
        let item = kinetik_ui_widgets::OutlinerItem::new(id(raw), label);
    ...
    fn expanded_model_rows() -> Vec<kinetik_ui_widgets::OutlinerRow> {
    ...
    fn assert_row_zones_finite(zones: &kinetik_ui_widgets::OutlinerRowZones) {
