//! Production Vello translation evidence for actual focused tab surfaces.
...
#[test]
fn actual_tab_focus_translates_as_contained_fill_only_annuli_at_release_scales() {
    ...
    .enumerate()
    {
        let id = WidgetId::from_key(format!("vello-tab-{case}"));
        let rect = Rect::new(origin.x, origin.y, 72.5, 24.25);
