//! Application-facing facade for the Stern toolkit.
//!
...
//! widget, text, platform, and renderer crates. During pre-alpha development,
//! this facade and its [`prelude`] are provisional Experimental
...
//! repository's `docs/public-api-policy.md`; final facade curation remains
//! gated on the complete public-workflow and release evidence.
...
/// alpha prelude will be curated only after the public editor workflow and
/// remaining release evidence establish a coherent application path.
pub mod prelude {
