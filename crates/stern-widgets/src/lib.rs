//! Reusable widgets built from Stern core primitives.
...
pub use chrome::{
    ActiveJobProgress, ApplicationBar, ApplicationBarConfig, ApplicationBarIntent,
    ApplicationBarOutput, ApplicationMenuBar, ChromeBandLayout, ChromeOverflowItem,
    ChromeOverflowPlacement, ChromeOverflowProjection, ChromeOverflowRequest,
    ChromeOverflowTrigger, ChromeScene, ChromeSceneConfig, ChromeSceneIntent, ChromeSceneItemKey,
    ChromeSceneOutput, ChromeSurfaceKind, DiagnosticField, DiagnosticFieldValue, DiagnosticSource,
    ...
    PreparedApplicationBar, StatusBar, StatusItem, StatusItemId, StatusItemKind, StatusProgress,
    TabStrip, TabStripMove, TabStripTarget, Toolbar, ToolbarGroup, ToolbarGroupId, ToolbarItem,
    ToolbarItemPresentation, WorkspaceTab, WorkspaceTabId, WorkspaceTabTarget,
...
pub use collections::{
    ...
    TableColumnConstraints, TableColumnResizeRequest, TableHeaderRect, TableLayout, TableSort,
    TreeExpansion, TreeItem, TreeLayout, TreeModel, TreeModelError, TreeRow, TreeRowRect,
    VirtualList, VirtualListConfig, VirtualListItemResponse, VirtualListOutput, VirtualListRow,
    VirtualListSelectionMode, VirtualRangeRequest, VirtualTable, VirtualTableConfig,
    ...
    VirtualTableSelectionResponse, VirtualTableTarget, VirtualTableWindow, VirtualTree,
    VirtualTreeConfig, VirtualTreeItemResponse, VirtualTreeOutput, VirtualTreeRow,
    VirtualTreeSelectionMode, VirtualWindow, VirtualWindowRequest, clamp_virtual_scroll_offset,
...
pub use components::{
    ...
    asset_slot_field, button, button_semantics, button_variant, checkbox, checkbox_semantics,
    ...
    icon_selectable_button, image, image_icon_button, image_icon_button_sized,
    image_icon_selectable_button, image_icon_selectable_button_sized, image_semantics, label,
    label_semantics, list_row, multi_line_text_field, multi_line_text_field_with_text_layouts,
    numeric_input, numeric_input_with_text_layouts, numeric_scrub_input,
    numeric_scrub_input_with_text_layouts, panel, panel_semantics, path_field,
    ...
    toggle_track_rect, toggle_with_label, toggle_with_label_target, vector2_scrub_input,
    vector3_scrub_input, vector4_scrub_input,
};
...
pub use timeline::{
    ...
    TimelineClipEditCancelRequest, TimelineClipEditController, TimelineClipEditIntent,
    TimelineClipEditKind, TimelineClipEditRejection, TimelineClipEditRejectionReason,
    TimelineClipEditRejectionStage, TimelineClipEditRequest, TimelineClipEditWidgetOutput,
    ...
    TimelineRulerTickRequest, TimelineScale, TimelineScrubBeginRequest, TimelineScrubController,
    TimelineScrubEndRequest, TimelineScrubIntent, TimelineScrubUpdateRequest, TimelineSelection,
    ...
    TimelineTrackDescriptor, TimelineTrackId, TimelineTransportContext, TimelineTrimEdge,
    TimelineViewportState, TimelineViewportZoomResult, TimelineWidget, TimelineWidgetConfig,
    TimelineWidgetIntent, TimelineWidgetOutput, TimelineZoom, TimelineZoomAnchorResult,
    TransportActionRequest, TransportControlDescriptor, TransportControlId, TransportControlIntent,
    ...
    timeline_clip_widget_id, timeline_item_semantics, timeline_item_widget_id,
    timeline_keyframe_semantics, timeline_keyframe_widget_id, timeline_lane_semantics,
    timeline_lane_widget_id, timeline_marker_semantics, timeline_marker_widget_id,
    timeline_root_semantics, timeline_ruler_ticks, timeline_semantics, timeline_snap_candidates,
...
pub use viewport::{
    ...
    ViewportToolSceneConfig, ViewportToolSceneOutput, ViewportToolSurfaceDescriptor,
    ...
    ViewportTransformHandleKind, ViewportTransformHandleResponse, ViewportTransformHandleSet,
    ViewportTransformInteractionPhase, ViewportTransformInteractionRequest, ViewportWidget,
    ViewportWidgetConfig, ViewportWidgetOutput, guide_primitives, hit_test_viewport_overlays,
    hit_test_viewport_overlays_at, hit_test_viewport_transform_handles,
    ...
    viewport_tool_widget_id, viewport_transform_handle_widget_id, viewport_transform_handles,
...
/// modules, for example `stern_widgets::dock::Dock` or
/// `stern_widgets::node_graph::NodeGraphDescriptor`.
pub mod prelude {
    pub use crate::{
        AssetSlotAsset, AssetSlotConfig, AssetSlotOutput, ColorFieldConfig, ColorFieldOutput,
        MultiLineTextFieldOutput, NumericInputDraft, NumericInputOutput, NumericInputPolicy,
