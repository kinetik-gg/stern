...
fn text_field_applies_input_while_focused() {
    ...
    let input = UiInput {
        text_events: vec![stern_core::TextInputEvent::Commit("a".to_owned())],
        ..UiInput::default()
    };
...
fn text_field_ignores_text_input_while_unfocused() {
    ...
    let input = UiInput {
        text_events: vec![stern_core::TextInputEvent::Commit("ignored".to_owned())],
        ..UiInput::default()
    };
...
fn text_field_single_line_input_drops_newlines_and_enter_key() {
    ...
    let input = UiInput {
        ...
        text_events: vec![stern_core::TextInputEvent::Commit("a\nb\r\nc".to_owned())],
        ..UiInput::default()
    };
...
fn multi_line_text_field_accepts_enter_while_focused() {
    ...
    let mut state = TextEditState::new("first");
    let input = UiInput {
        keyboard: stern_core::KeyboardInput {
            modifiers: Modifiers::default(),
            events: vec![KeyEvent::new(
                Key::Enter,
                KeyState::Pressed,
...
fn canonical_replay_resolves_impossible_equal_ordinals_pointer_first() {
    ...
    use stern_core::{OrderedTextInputEvent, TextInputEvent, UiInputEvent};
    use stern_text::TextEditMode;
    ...
    let result = replay_text_field_events(
        ...
        vec![ResolvedTextPointerAction {
            ...
            model_caret: Some(stern_text::TextCaret::at(1)),
            click_count: 1,
            modifiers: Modifiers::default(),
...
fn canonical_replay_retains_one_outer_focus_loss_fence() {
    ...
    let result = replay_text_field_events(
        ...
        vec![ResolvedTextPointerAction {
            ordinal: Some(3),
            phase: TextPointerPhase::Press,
            model_caret: Some(stern_text::TextCaret::at(0)),
            click_count: 1,
            modifiers: Modifiers::default(),
            release_clicked: false,
        }],
    ...
    let result = replay_text_field_events(
        ...
        vec![
            ...
            ResolvedTextPointerAction {
                ...
                model_caret: Some(stern_text::TextCaret::at(4)),
                click_count: 0,
                modifiers: Modifiers::default(),
                release_clicked: false,
            },
...
fn focus_loss_fences_place_caret_and_release_metadata_drives_selection() {
    ...
    let result = replay_text_field_events(
        ...
        vec![ResolvedTextPointerAction {
            ordinal: Some(2),
            phase: TextPointerPhase::PlaceCaret,
            model_caret: Some(stern_text::TextCaret::at(7)),
            click_count: 2,
    ...
    let _ = replay_text_field_events(
        ...
        vec![ResolvedTextPointerAction {
            ordinal: Some(2),
            phase: TextPointerPhase::PlaceCaret,
            model_caret: Some(stern_text::TextCaret::at(5)),
            click_count: 1,
            modifiers: Modifiers::new(true, false, false, false),
            release_clicked: true,
        }],
...
fn shaped_replay_validation_failure_consumes_without_scalar_fallback() {
    ...
    use stern_core::{Key, KeyEvent, KeyState, OrderedTextInputEvent, UiInputEvent};
    use stern_text::TextEditMode;
...
fn configured_unavailable_navigation_is_fail_closed_but_no_store_keeps_legacy_preedit() {
    ...
    use stern_core::{Key, KeyEvent, KeyState, OrderedTextInputEvent, UiInputEvent};
    use stern_text::{TextComposition, TextEditMode};
...
fn fallback_wrapped_geometry_shares_rows_for_paint_hit_selection_caret_and_extent() {
    ...
    use stern_core::{Brush, ComponentState};
    ...
    assert_eq!(
        ...
        Some(
            geometry
                .caret_content_rect()
                .translate(stern_core::Vec2::new(recipe.padding_x, recipe.padding_y,))
        )
    );
